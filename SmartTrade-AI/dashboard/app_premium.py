...
def create_ml_analysis_section():
    """Create IENG 4020 ML Analysis section with all 9 ML categories."""
    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.Div([
                    html.H4("IENG 4020 Analysis", className="mb-0", style={'fontWeight': '700', 'letterSpacing': '-0.5px'}),
...
# IENG 4020 ML Analysis Callback - All 9 Categories
@app.callback(
...
def train_all_ml_models(n_clicks, symbol):
    """Train all ML models across 9 categories for IENG 4020 analysis."""
    import numpy as np
    import traceback
