...
|----------|-------------|
| [ML_Project_Report.md](docs/ML_Project_Report.md) | Academic research paper (5,500+ words) |
| [Presentation_Slides.md](docs/Presentation_Slides.md) | 15-minute conference presentation |
| [Demo_Guide.md](docs/Demo_Guide.md) | Live demonstration walkthrough |
| [Fairness_Audit.md](docs/Fairness_Audit.md) | Bias and fairness analysis |
| [API_Reference.md](docs/API_Reference.md) | Function and class documentation |
...
|-------|----------------|
| Gradient Descent | Adam optimizer in deep learning |
| Cross-validation | TimeSeriesSplit, 5-fold CV |
| Regularization | Dropout, BatchNorm, L2, Early Stopping |
| Ensemble Methods | Stacking, Bagging, Boosting, Voting |
| Neural Networks | LSTM, CNN, Transformer |
| Reinforcement Learning | DQN, Policy Gradient, Actor-Critic |
| Generative AI | LLM Trading Assistant |
| Ethics & Fairness | Fairness Audit, Explainable AI |
...
**Built with ❤️ for Humber College IEIT 4015 Machine Learning Course**
